...
import com.inautix.training.counselling.dao.profileChangerDAO;
...
/**
 * Servlet implementation class profilechangeservelet
 */
@WebServlet("/profilechangeservelet")
public class profilechangeservelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public profilechangeservelet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		profileChangerDAO pc = new profileChangerDAO();
